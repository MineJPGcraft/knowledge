...
*   **类型**: 群组服
*   **版本**: 1.21.X
*   **描述**: JE1.12.2-1.21.x。历经一年半打造的小型群组服务器。有生存服，小游戏，生电服(后续可能会增加玩法)。
...
*   **IP**: 2b2t.best�以及永不妥协的优化体验！]




�接**: https://qm.qq.com/q/MJtHBEM4cC
*   **IP**: 2b2t.best��生存，那就加入我们！加入HCE，让我们一起在圣苦力怕的大陆上建造自己的世界吧！',
...
��优化！致力于打造最好的无规则服务器！这里只有最硬核的自由，最经典的混沌，以及永不妥协的优化体验！',
      link: 'https://qm.qq.com/q/MJtHBEM4cC',
      ip: '2b2t.best'
    }
   ]
